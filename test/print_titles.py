...
def compare_titles(directory=None, titles_filename='titles.json', bad_filenames=None, debug=False):
    ...
    for i in range(len(directory_filenames)):
        ...
        if debug:
            ...
            'string2:', string2
            print
            'Is "{string1}" in "{string2}"?'.format(string1=string1, string2=string2)
            print
            'Answer:', compare
        if compare:
            ...
            print
            '[ERROR] "{string1}" is not in "{string2}"...'.format(string1=string1, string2=string2)
