...
class PosterFinder:
    def __init__(self, directory=None, contents_file="contents.json", verbose=False):
        ...
        self.get_posters(
            directory=directory, contents_file=contents_file, verbose=verbose
        )
    ...
    def get_posters(
        self, directory=None, contents_file=None, api_key="967174e1", verbose=None
    ):
